function res = netFlow2(~, params) %doesn't account for mass loss because we are bad and everything sucks.
    params = params.';
...
%     display(convectionLHL)
    ...
    liquidEnergy = liquidEnergy + radiation + conductionBTL;
...
%     flowParams(10) = conductionBTL + radiation - massChange(1);
